<?php
namespace Kanboard\Plugin\Wechat\Controller;
...
class TelegramController extends BaseController
{
    ...
    {
        file_put_contents('aaaaaaaaaaaaaaaaaaaaaaaaa.txt',1,FILE_APPEND);
        $user = $this->getUser();
        //$this->checkCSRFParam();
    ...
    {
        file_put_contents('aaaaaaaaaaaaaaaaaaaaaaaaa.txt',2,FILE_APPEND);
    ...
    {
        file_put_contents('aaaaaaaaaaaaaaaaaaaaaaaaa.txt',3,FILE_APPEND);
        try
        {
    ...
    {
        file_put_contents('aaaaaaaaaaaaaaaaaaaaaaaaa.txt',4,FILE_APPEND);
        $user = $this->getUser();
        $this->checkCSRFParam();
    ...
    {
        file_put_contents('aaaaaaaaaaaaaaaaaaaaaaaaa.txt',5,FILE_APPEND);
        $project = $this->getProject();
        $this->checkCSRFParam();
