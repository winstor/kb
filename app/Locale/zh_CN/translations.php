...
return array(
    ...
    'A link to reset your password has been sent by email.' => '密码重置链接已发送到邮箱。',
    'Your profile must have a valid email address.' => '个人资料必须有一个有效email地址。',
    'Unfortunately, we are unable to reset your password. Did you enter a valid username? Do you have an email address in your profile?' => '抱歉，无法重置你的密码。请确认输入正确的用户名或email地址？',
